...
export const DEFAULT_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    sku: 'MB-SLB-CR030',
    category: 'Marble',
    subcategory: 'Premium Marble Slabs',
    price: 320.00,
    unit: 'sqft',
    size: 'Slab Lot',
    stock: 5400,
    minStock: 500,
    description: 'Iconic, high-grade Italian Carrara white marble slab with smooth signature gray wispy veins. Perfect for custom floor layouts, wall panels, countertops, and luxury tables.',
    features: [
      'Genuine 100% natural Italian Carrara Marble',
      'Pristine white background with classic veins',
      'Can be customized using the slab/block dimensions calculator',
      'Requires professional stone installation and periodic sealing'
    ],
    color: 'White & Gray',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1603006905393-0182ce7ba019?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Pure White (1mm)'
  },
  {
    id: 'p14',
    name: 'Indian Forest Green Marble Slab',
    sku: 'MB-SLB-FG025',
    category: 'Marble',
    subcategory: 'Polished Marble Slabs',
    price: 180.00,
    unit: 'sqft',
    size: 'Slab Lot',
    stock: 3500,
    minStock: 400,
    description: 'Rich deep forest green natural marble with exquisite intricate dark green and golden serpentine veining, creating an immersive, jungle-forest aesthetic on wide panels or flooring.',
    features: [
      'High density natural Indian Serpentine Green Marble',
      'Dramatic, beautiful high-contrast deep green veins',
      'Suitable for both book-matched or running arrangements',
      'Extremely durable marble suited for vanity tops, lobby entryways, accent walls'
    ],
    color: 'Dark Green',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Forest Green (1mm)'
  },
  {
    id: 'p15',
    name: 'Turkish Emperador Dark Marble Slab',
    sku: 'MB-SLB-EM022',
    category: 'Marble',
    subcategory: 'Turkish Marble Slabs',
    price: 290.00,
    unit: 'sqft',
    size: 'Slab Lot',
    stock: 4200,
    minStock: 300,
    description: 'Exquisite deep brown Turkish marble featuring fine, spider-web cream and gold thread veins. Popularly sought-after for cozy luxury fireplaces and warm foyer pavements.',
    features: [
      'Premium Turkish Emperador Stone with beautiful organic veining',
      'Intricate golden-caramel web veins contrast over rich dark chocolate ground',
      'Polished surface reflecting soft ambient light seamlessly',
      'Standard 18mm high tolerance slab cut'
    ],
    color: 'Dark Brown',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1590381105924-c72589b9ef3f?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Dark Brown (1.5mm)'
  },
  {
    id: 'p16',
    name: 'Greek Volakas White Marble Slab',
    sku: 'MB-SLB-VK018',
    category: 'Marble',
    subcategory: 'Premium Marble Slabs',
    price: 340.00,
    ...
    stock: 2800,
    minStock: 250,
    description: 'Elegant cloud-like gray and light burgundy diagonals across a snowy white background. Volakas marble yields a soft, airy atmosphere optimal for bright bathroom vanities and floor spaces.',
    features: [
      'Direct imported Greek Volakas Quartzite Quality',
      'Diagonal clouds with premium light-reflecting index',
      'Resistant to natural humidity and micro-cracking',
      'Polished pristine facade'
    ],
    color: 'Snow White',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1588854337236-6889d631faa8?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'White-Silver (1mm)'
  },
  {
    id: 'p17',
    name: 'Spanish Nero Marquina Black Marble',
    sku: 'MB-SLB-NM028',
    category: 'Marble',
    subcategory: 'Spanish Marble Slabs',
    price: 310.00,
    unit: 'sqft',
    size: 'Slab Lot',
    stock: 3800,
    minStock: 300,
    description: 'Striking jet-black Spanish marble accented with crystalline, lightning-fast white fossil veins. Highly popular for modern high-contrast statement walls, thresholds, and executive desks.',
    features: [
      'Authentic Spanish Nero Marquina extraction',
      'High-density deep calcareous black rock base',
      'Outstanding polished brilliance and reflection depth',
      'Requires wet-diamond polished edging during setup'
    ],
    color: 'Jet Black',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Charcoal Black (1mm)'
  },
  {
    id: 'p18',
    name: 'Italian Statuario White Marble Slab',
    sku: 'MB-SLB-ST035',
    category: 'Marble',
    subcategory: 'Elite Italian Slabs',
    price: 650.00,
    unit: 'sqft',
    size: 'Slab Lot',
    stock: 1200,
    minStock: 150,
    description: 'The absolute pinnacle of luxury stones. Bright, cold pure white body with heavy, bold, dramatic charcoal gray ribbons. Highly sought after for master bedroom book-match layouts.',
    features: [
      'Rare, elite Carrara-exclusive Statuario block slice',
      'Staggering aesthetic impact for luxury projects',
      'Precision ground, pristine polished calibration',
      'Handpacked and inspected individually'
    ],
    color: 'Pure White',
    finish: 'Polished',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1516962215378-7fa2e137ae93?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Statuario White (1mm)'
  },
  {
    id: 'p19',
    name: 'Indian Rain Forest Brown Marble',
    sku: 'MB-SLB-RF018',
    category: 'Marble',
    subcategory: 'Polished Marble Slabs',
    price: 160.00,
    ...
    stock: 4500,
    minStock: 500,
    description: 'Earthy luxury marble featuring beautiful tree-branch like dark brown and orange veins on an olive-tan base. Lends an exotic, rustic wood-grain texture when used as accents.',
    features: [
      'Serpentine Indian Rainforest Brown origin',
      'Beautiful tree-venation mesh with outstanding density',
      'Naturally slip-resistant texture post matte brush',
      'Extremely easy maintenance compared to white marbles'
    ],
    color: 'Earthy Brown',
    finish: 'Satin',
    material: 'Natural Marble',
    image: 'https://images.unsplash.com/photo-1525498128493-380d1990a112?auto=format&fit=crop&w=600&q=80',
    groutSuggestion: 'Sand-Stone Beige (1.5mm)'
  }
];
